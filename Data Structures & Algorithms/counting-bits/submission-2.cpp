...
public:
    vector<int> countBits(int n) {
        ...
        // dp method 2 == use right shift operator
        // the idea is similar but in terms of set bits 
        // sb(i) = sb(i >> 1) + (i & 1 : basically rightmost bit because we moved right by 1 bit hahahaha lol)
        vector<int> dp(n+1);
        dp[0] = 0;
